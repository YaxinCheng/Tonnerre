...
final class GeneralLoader: ServiceLoader {
  ...
  */
  ...
  init() {
    let GeneralProviders: [TonnerreService.Type] = [FileNameSearchService.self, FileContentSearchService.self, GoogleSearch.self, AmazonSearch.self, WikipediaSearch.self, GoogleImageSearch.self, YoutubeSearch.self, GoogleMapService.self, DictionarySerivce.self, GoogleTranslateService.self, BingSearch.self, DuckDuckGoSearch.self, ChromeBMService.self, TerminalService.self, ClipboardService.self]
